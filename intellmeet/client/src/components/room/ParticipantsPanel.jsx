        ...
        {filteredParticipants.map((p) => (
          <div className="participant-row" key={p.id}>
            <div className="participant-row-left">
              <div className={`participant-row-avatar ${p.avatarBg}`} style={p.initials && (p.initials.startsWith('http') || p.initials.startsWith('/') || p.initials.startsWith('data:')) ? { padding: 0, overflow: 'hidden' } : {}}>
                {p.initials && (p.initials.startsWith('http') || p.initials.startsWith('/') || p.initials.startsWith('data:')) ? (
